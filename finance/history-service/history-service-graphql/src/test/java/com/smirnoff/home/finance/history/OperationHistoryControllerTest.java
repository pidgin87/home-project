...
//                List.of(new ProductModel("id:SourceProduct", "name:SourceProduct", ProductTypeModel.ACCOUNT, null))
//        );
//
//        GraphQlResponse<GetOperationHistoryDtoList> response = operationHistoryClient.getOperationList(GraphQlRequest.builder()
//                .query(GET_OPERATION_LIST)
...
//        Mockito.when(productAdapter.getByIds(anyList())).thenReturn(
//                List.of(new ProductModel("id:DestinationProduct", "name:DestinationProduct", ProductTypeModel.BROKER_ACCOUNT, null))
//        );
//
//        GraphQlResponse<GetOperationHistoryDtoList> response = operationHistoryClient.getOperationList(GraphQlRequest.builder()
//                .query(GET_OPERATION_LIST)
